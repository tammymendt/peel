...
class MapReduce2(version: String, lifespan: Lifespan, dependencies: Set[System] = Set(), mc: Mustache.Compiler) extends System("mapred-2", version, lifespan, dependencies, mc) {
